...
namespace Business
{
    public partial class BusinessStartup
    {
        ...
        public void ConfigureDevelopmentServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IDestekRepository, DestekRepository>();
            services.AddTransient<IRotaAnasayifaRepository, RotaAnasayifaRepository>();

            services.AddTransient<IPuanRepository, PuanRepository>();
            services.AddTransient<IGunlerRepository, GunlerRepository>();
            services.AddTransient<IResimTipiRepository, ResimTipiRepository>();
            services.AddTransient<IYorumlarRepository, YorumlarRepository>();
            services.AddTransient<IUlkeRepository, UlkeRepository>();
            services.AddTransient<ISehirRepository, SehirRepository>();
            services.AddTransient<IRotaGaleriRepository, RotaGaleriRepository>();
            services.AddTransient<IRotaDetayiRepository, RotaDetayiRepository>();
            services.AddTransient<IRotaRepository, RotaRepository>();
            services.AddTransient<IKategoriRepository, KategoriRepository>();
            services.AddTransient<IBolgelerRepository, BolgelerRepository>();
